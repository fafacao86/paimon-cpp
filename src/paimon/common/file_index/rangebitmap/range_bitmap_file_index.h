...
class RangeBitmapFileIndex : public FileIndexer {
 public:
...
class RangeBitmapFileIndexWriter : public FileIndexWriter {
 public:
 ...
 private:
  RangeBitmapFileIndexWriter(std::shared_ptr<arrow::DataType> arrow_type,
...
class RangeBitmapFileIndexReader : public FileIndexReader,
 ...
 private:
  RangeBitmapFileIndexReader(std::unique_ptr<RangeBitmap> range_bitmap);
  ...
  Result<std::shared_ptr<FileIndexResult>> VisitNotIn(const std::vector<Literal>& literals) override;
