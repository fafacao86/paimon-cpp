...
FixedLengthChunk::FixedLengthChunk(Literal key, const int32_t code, const int32_t keys_length_limit,
                                   const std::shared_ptr<KeyFactory>& factory, const int32_t fixed_length)
    : version_(CURRENT_VERSION),
      key_(std::move(key)),
      code_(code),
      offset_(0),
