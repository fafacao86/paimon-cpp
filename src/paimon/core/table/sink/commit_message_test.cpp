...
TEST(CommitMessageTest, TestCompatibleWithVersion10) {
    ...
    auto file_meta = std::make_shared<DataFileMeta>(
        ...
        /*min_key=*/BinaryRowGenerator::GenerateRow({"Tony", 0}, pool.get()),
        /*max_key=*/BinaryRowGenerator::GenerateRow({"Tony", 0}, pool.get()),
        /*key_stats=*/
        BinaryRowGenerator::GenerateStats({"Tony", 0}, {"Tony", 0}, {0, 0}, pool.get()),
        /*value_stats=*/
...
TEST(CommitMessageTest, TestCompatibleWithVersion8) {
    ...
    auto file_meta2 = std::make_shared<DataFileMeta>(
        ...
        /*key_stats=*/SimpleStats::EmptyStats(),
        /*value_stats=*/
        BinaryRowGenerator::GenerateStats({"Alex", 10, 0, 12.1}, {"Tony", 10, 0, 16.1},
                                          {0, 0, 0, 0}, pool.get()),
...
TEST(CommitMessageTest, TestCompatibleWithVersion7) {
    ...
    auto file_meta2 = std::make_shared<DataFileMeta>(
        ...
        /*max_key=*/BinaryRowGenerator::GenerateRow({"Tony", 0}, pool.get()),
        /*key_stats=*/
        BinaryRowGenerator::GenerateStats({"Alex", 0}, {"Tony", 0}, {0, 0}, pool.get()),
        /*value_stats=*/
        BinaryRowGenerator::GenerateStats({"Alex", 10, 0, 12.1}, {"Tony", 10, 0, 16.1},
                                          {0, 0, 0, 0}, pool.get()),
        /*min_sequence_number=*/0, /*max_sequence_number=*/3, /*schema_id=*/0,
...
TEST(CommitMessageTest, TestCompatibleWithVersion5) {
    ...
    auto file_meta2 = std::make_shared<DataFileMeta>(
        ...
        BinaryRowGenerator::GenerateRow({"Lily", 0}, pool.get()),
        BinaryRowGenerator::GenerateRow({"Tony", 0}, pool.get()),
        BinaryRowGenerator::GenerateStats({"Lily", 0}, {"Tony", 0}, {0, 0}, pool.get()),
        BinaryRowGenerator::GenerateStats({"Lily", 10, 0}, {"Tony", 10, 0}, {0, 0, 0}, pool.get()),
...
TEST(CommitMessageTest, TestCompatibleWithJavaPaimon10WithStatsDenseStore) {
    ...
    auto file_meta3 = std::make_shared<DataFileMeta>(
        ...
        /*min_key=*/BinaryRow::EmptyRow(), /*max_key=*/BinaryRow::EmptyRow(),
        /*key_stats=*/SimpleStats::EmptyStats(),
        BinaryRowGenerator::GenerateStats({"Lucy", 20, 1}, {"Lucy", 20, 1}, {0, 0, 0}, pool.get()),
        /*min_sequence_number=*/0, /*max_sequence_number=*/0, /*schema_id=*/0,
        /*level=*/0, /*extra_files=*/std::vector<std::optional<std::string>>(),
...
TEST(CommitMessageTest, TestCompatibleWith09JavaPaimon2) {
    ...
    expected_msgs.emplace_back(BinaryRowGenerator::GenerateRow({10}, pool.get()), /*bucket=*/1,
                               ...
                               CompactIncrement({}, {}, {}));
    // handle null value
    auto simple_stats = BinaryRowGenerator::GenerateStats({"Paul", 20, 1, 0}, {"Paul", 20, 1, 0},
                                                          {0, 0, 0, 1}, pool.get());
...
TEST(CommitMessageTest, TestPkTableCompatibleWithJavaPaimon09) {
    ...
    auto file_meta = std::make_shared<DataFileMeta>(
        ...
        /*min_key=*/BinaryRowGenerator::GenerateRow({"Bob", 0}, pool.get()),
        /*max_key=*/BinaryRowGenerator::GenerateRow({"Emily", 0}, pool.get()),
        /*key_stats=*/
        BinaryRowGenerator::GenerateStats({"Bob", 0}, {"Emily", 0}, {0, 0}, pool.get()),
        BinaryRowGenerator::GenerateStats({"Bob", 10, 0, 12.0}, {"Emily", 10, 0, 113.1},
                                          {0, 0, 0, 0}, pool.get()),
    ...
    auto file_meta_with_level = std::make_shared<DataFileMeta>(
        ...
        /*min_key=*/BinaryRowGenerator::GenerateRow({"Bob", 0}, pool.get()),
        /*max_key=*/BinaryRowGenerator::GenerateRow({"Bob", 0}, pool.get()),
        /*key_stats=*/
        BinaryRowGenerator::GenerateStats({"Bob", 0}, {"Bob", 0}, {0, 0}, pool.get()),
        BinaryRowGenerator::GenerateStats({"Bob", 10, 0, 113.1}, {"Bob", 10, 0, 113.1},
                                          {0, 0, 0, 0}, pool.get()),
        /*min_sequence_number=*/5, /*max_sequence_number=*/5, /*schema_id=*/0,
        /*level=*/4, /*extra_files=*/std::vector<std::optional<std::string>>(),
